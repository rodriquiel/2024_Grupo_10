...
import pruebaGUI.GUIAdminConDatosTest;
import pruebaGUI.GUIAdminVacioTest;
import pruebaGUI.GUIClienteConDatosTest;
import pruebaGUI.GUIClienteVacioTest;
...
@RunWith(Suite.class)
@SuiteClasses({GUIEnabledDisabledLogRegTest.class,
	GUIEnabledDisabledAdminTest.class,
	GUIEnabledDisabledClienteTest.class,
	GUILogRegConDatosTest.class,
	GUILogRegVacioTest.class,
	GUIAdminConDatosTest.class,
	GUIAdminVacioTest.class,
	GUIClienteConDatosTest.class,
	GUIClienteVacioTest.class,
	EmpresaDTOTest.class,
	PersistenciaTest.class,
	ControladorTestMetodosBasicos.class,
	MetodosConMensajesAMostrar.class,
	MetodosConMensajesAMostrar2.class,
	MetodosConMensajesAMostrar3.class,
	AdministradorTest.class,
	AutoTest.class,
	CalificacionDeChoferTest.class,
	ChoferPermanenteTest.class,
	ChoferTemporarioTest.class,CombiTest.class,
	CrearViajeTest.class,
	Empresa_AgregarTest.class,
	EmpresaSinlgetonTest.class,
	EmpresaTest.class,
	GetPedidoDeCliente.class,
	GetUsuarioLogueadotest.class,
	GetViajeDeClienteTest.class,
	isAdminTest.class,
	LoginTest.class,
	LogOutTest.class,
	MotoTest.class,
	PagarYFinalizarTest.class,
	PedidoTest.class,
	SetUsuarioLogueadoTest.class,
	UsuarioTest.class,
	ViajeTest.class})
